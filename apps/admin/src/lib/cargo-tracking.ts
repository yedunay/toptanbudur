/**
 * Kargo takip deep-link haritası ve yardımcıları (admin SPA mirror).
 * frontend/lib/cargo-tracking.ts ile aynı şemayı paylaşır; bu kopya admin
 * arayüzünde sipariş talep detayında "Kargo Takip" butonu için kullanılır.
 */
